...
available. The code in this section adds those variables to an existing
newCDF file, renaming the result with names like xxxrf01KF.nc if the
original file was xxxrf01.nc. 
